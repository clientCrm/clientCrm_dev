...
/**
        ...
        PageResult<crmTask> result =crmTaskServer.selectByName(selectType,crmUserId, value,page,rows);
...
/**
     ...
     */
        ...
        PageResult<crmTask> result = crmTaskServer.selectByStatus(selectType,crmUserId, value,page,rows);
...
/**
        ...
        PageResult<crmTask>  result= crmTaskServer.selectByLevel(selectType,crmUserId, value,page,rows);
...
/**
     ...
     */
        ...
        PageResult<crmTask>  result= crmTaskServer.selectByTimeType(selectType,crmUserId, value,page,rows);
...
/**
     ...
     */
       ...
       PageResult<crmTask>  result= crmTaskServer.selectByUserName(selectType,crmUserId, value,page,rows);
...
//*根据我的任务的Id查找任务的详情*//*
    ...
    @GetMapping("getTaskByTaskId")
        public crmTaskLayui getTaskByTaskId(@RequestParam("taskId") Integer taskId){
        return crmTaskServer.selectTaskInfoById(taskId);
    }
